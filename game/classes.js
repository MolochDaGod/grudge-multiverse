...
export const CLASSES = [
  ...
  },
  {
    ...
    meshHints: null,
    /** Nature staff kit — slot 1 = thorn lance (red_thorn projectile) */
    skills: [
      {
        id: "thorn_basic",
        name: "Thorn Shot",
      ...
      { id: "vine_ward", name: "Vine Ward", key: "Digit2", shift: true, level: 2, cd: 16, dmgMul: 0, kind: "buff", school: "nature" },
      { id: "bramble", name: "Bramble Burst", key: "Digit3", shift: true, level: 3, cd: 12, dmgMul: 1.8, kind: "magic_aoe", aoeR: 4.8, rangeM: 16, school: "nature" },
      { id: "blink", name: "Grove Step", key: "Digit4", shift: true, level: 4, cd: 12, dmgMul: 0, kind: "mobility", gapClose: 9, rangeM: 9, school: "nature" },
      { id: "storm", name: "Tempest", key: "Digit5", shift: true, level: 5, cd: 25, dmgMul: 2.8, kind: "magic_aoe", aoeR: 6.0, rangeM: 16, school: "nature" },
    ],
  },
  {
    id: "worge",
